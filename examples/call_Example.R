...
SSS.ais.fxn(filepath = "C:/My_Directory/.../", 
            ...
            tantalus = FALSE, # Option for use with linux systems, NWFSC specific
            read.seed = FALSE, # Option to allow the user to predefine seeds from previous model run, reads the seed_list file
