...
##' @export 
define_matrix <- function(N, ofl.yrs, depl.yr, n.survey, n.extra.se){

	names <- c("M_f","M_m","h","depl","LnR0",
			   "SB0",paste0("SPB_",ofl.yrs[1]),paste0("Dep_TgtYr_",depl.yr),
               ...
               paste0("Survey_Q_",1:n.survey))

	if (n.extra.se > 0) { names <- c(names, paste0("extra_se_",1:n.extra.se)) }
